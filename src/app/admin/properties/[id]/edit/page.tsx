      ...
      <form action={action} className="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="city" required defaultValue={property.city} className="input" />
          </div>
          <div>
          ...
          <div>
            ...
            <input name="zip" required defaultValue={property.zip} className="input" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">Type *</label>
            <select name="type" required defaultValue={property.type} className="input">
          ...
          <div>
            ...
            <input name="sqft" type="number" min="0" defaultValue={property.sqft ?? ""} className="input" />
          </div>
          <div>
